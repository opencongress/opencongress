  ...
  def index
    unless read_fragment("frontpage_rightside")
      @index_tabs = [
              ...
              :partial => 'bill',
              :collection => Bill.find_by_most_commentary('news', 5, 1000.days, DEFAULT_CONGRESS),
              :id => 'bns',
              ...
              :partial => 'bill',
              :collection => ObjectAggregate.popular('Bill', DEFAULT_COUNT_TIME, 1000),
              :id => "bv",
              ...
              :partial => 'issue',
              :collection => ObjectAggregate.popular('Subject', DEFAULT_COUNT_TIME, 1000),
              :style => 'display: none;',
              :id => 'pis',
              :link => '/issues',
              :count_type => 'views'}]

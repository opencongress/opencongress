...
EOT
  ...
  def page_title
    title = ""
    unless @site_text_page.title_tags.nil? and @site_text_page.title_tags.blank?
  ...
  def bookmarking_image
    "<link rel=\"image_src\" href=\"" + (@bookmarking_image.blank? ? "/stylesheets/img/fb-default.jpg" : @bookmarking_image) + "\" />"
  end

...
<div id="wrapper">
  ...
  <div id="header" class="clearfix">
  	...
  	<h1><a class="logo" href="/" title="link to the home page"><img src="/images/open-congress.png" alt="OpenCongress -" /></a></h1>
  	...
  	<div class="right">
  		...
  		<div id="login" style="display:none;">
  			<form action='/login' method='post'>
  				...
  				<input name="commit" type="image" src="/images/login.png" value="Login" />
  			</form>
